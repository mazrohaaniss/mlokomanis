...
import { ArrowRight, Eye, Target, MapPin, Phone, Leaf, Building2, Music } from 'lucide-react';
  ...
  return (
    <div className="bg-white">
      ...
      <section 
        ...
        style={{ backgroundImage: "url('https://upload.wikimedia.org/wikipedia/commons/d/d2/Paddy_fields_in_Wonogiri%2C_Central_Java%2C_Indonesia.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}
      >
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <a href="#tentang" className="inline-flex items-center gap-2 bg-yellow-400 text-green-900 px-8 py-3 rounded-full font-bold text-lg hover:bg-yellow-300 transition-all duration-300 transform hover:scale-105 shadow-lg">
      ...
      <section className="py-24 bg-gradient-to-b from-white to-green-50/50">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-gray-500 mb-12 max-w-2xl mx-auto">Kekayaan dan keunikan yang menjadi motor penggerak kemajuan Desa Mlokomanis Wetan.</p>
          
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: <Leaf size={32} />, title: "Pertanian", desc: "Sektor utama dengan hasil padi, jagung, dan sayuran yang melimpah.", color: "text-green-600" },
              { icon: <Building2 size={32} />, title: "Pabrik Tahu", desc: "Industri rumahan yang menjadi tulang punggung ekonomi lokal.", color: "text-yellow-600" },
              { icon: <Music size={32} />, title: "Karawitan", desc: "Seni budaya gamelan yang terus hidup dan dilestarikan oleh masyarakat.", color: "text-red-600" }
            ].map(item => (
              <div key={item.title} className="bg-white rounded-2xl p-8 group transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 transform cursor-pointer">
                <div className={`w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6 transition-all duration-300 group-hover:scale-110 group-hover:bg-yellow-400 ${item.color} group-hover:text-white`}>
                  {item.icon}
                </div>
      ...
      <section className="py-24 bg-green-800 text-white">
        <div className="container mx-auto px-6">
          <div className="text-center">
            ...
            <p className="text-green-200 mb-12">Punya pertanyaan atau ingin berkolaborasi? Kami siap mendengarkan.</p>
          </div>
          ...
          <div className="max-w-4xl mx-auto bg-white/10 p-8 sm:p-12 rounded-2xl shadow-lg backdrop-blur-sm">
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                 <div>
                    <h3 className="text-lg font-bold flex items-center gap-3"><MapPin size={20} className="text-yellow-400" /> Alamat Kantor Desa</h3>
                    <p className="text-green-200 mt-1 pl-8">Jl. Mlokomanis Wetan, Kec. Ngadirojo, Kabupaten Wonogiri, Jawa Tengah 57678</p>
                  </div>
                 <div>
                    <h3 className="text-lg font-bold flex items-center gap-3"><Phone size={20} className="text-yellow-400" /> Telepon & Email</h3>
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input type="text" id="name" placeholder="Nama Anda" className="mt-1 w-full p-3 rounded-lg bg-white/20 border-white/30 focus:border-yellow-400 focus:ring focus:ring-yellow-400/50 transition text-white placeholder-green-200" />
                </div>
                <div>
                  <label htmlFor="email" className="text-sm font-medium text-green-200">Email</label>
                  <input type="email" id="email" placeholder="email@anda.com" className="mt-1 w-full p-3 rounded-lg bg-white/20 border-white/30 focus:border-yellow-400 focus:ring focus:ring-yellow-400/50 transition text-white placeholder-green-200" />
                </div>
                <div>
                  <label htmlFor="message" className="text-sm font-medium text-green-200">Pesan</label>
                  <textarea rows="4" id="message" placeholder="Tuliskan pesan Anda di sini..." className="mt-1 w-full p-3 rounded-lg bg-white/20 border-white/30 focus:border-yellow-400 focus:ring focus:ring-yellow-400/50 transition resize-none text-white placeholder-green-200"></textarea>
                </div>
                <div className="text-right">
                  <button type="submit" className="bg-yellow-400 text-green-900 px-8 py-3 rounded-lg font-bold hover:bg-yellow-300 transition-colors duration-300 transform hover:scale-105">
                    Kirim Pesan
                  </button>
                </div>
              </form>
