      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col">
          <div className="h-48 flex items-center justify-center">
            <img src="/images/pasha.jpg" alt="Video Profil Desa" className="w-full h-full object-cover" />
          </div>
        ...
        <div className="p-6 flex flex-col flex-grow">
          ...
          <div className="mt-auto flex gap-3">
            <button 
              ...
              className="flex-1 bg-gradient-to-r from-green-500 to-green-600 text-white px-4 py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path d="M10 12a2 2 0 100-4 2 2 0 000 4z" />
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm0 2a10 10 0 100-20 10 10 0 000 20z" clipRule="evenodd" />
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col">
          <div className="h-48 flex items-center justify-center">
            <img src="/images/imam.png" alt="Pertanian Sebagai Bidang Ilmu" className="w-full h-full object-cover" />
          </div>
          <div className="p-6 flex flex-col flex-grow">
            <h3 className="text-xl font-bold text-green-800 mb-3">Folklor Pertanian Desa Mlokomanis Wetan</h3>
            <p className="text-gray-600 mb-4 text-sm flex-grow">
            Tentang cerita, kepercayaan, dan tradisi khususnya dipertanian yang diwariskan secara turun temurun lewat lisan            </p>
            <button 
      ...
      <div className="space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="group">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              <div className="relative cursor-pointer" onClick={() => openModal('/images/eca2.png', 'Pemetaan Data UMKM', 'Pemetaan Data UMKM')}>
                <img
                  src="/images/eca2.png"
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-green-800 mb-3">Pemetaan Data UMKM </h3>
          ...
          <div className="group">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              <div className="relative cursor-pointer" onClick={() => openModal('/images/tesi2.jpg', 'Peta Persebaran UMKM Desa Mlokomanis Wetan', 'Peta Persebaran UMKM Desa Mlokomanis Wetan')}>
                <img
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-green-800 mb-3">Peta Persebaran UMKM Desa Mlokomanis Wetan</h3>
                <p className="text-gray-600 text-sm">
                Peta Persebaran UMKM Desa Mlokomanis Wetan menampilkan lokasi berbagai usaha untuk mengenalkan potensi ekonomi desa dan mendukung pengembangan UMKM.                </p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="group">
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500">
            <div className="relative cursor-pointer" onClick={() => openModal('/images/ayeca1.jpg', 'Peta Tematik Tesa dan Ayesha', 'Peta Tematik Komprehensif - Tesa dan Ayesha')}>
              <img
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <h3 className="text-xl font-bold mb-2">Peta Tematik aye eca gabung</h3>
